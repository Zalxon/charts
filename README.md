...
[github]: https://github.com/zalxon/charts
[github-badge]: https://badgen.net/badge/-/github?icon=github&label
[build status]: https://github.com/zalxon/charts/actions/workflows/main.yml/badge.svg
[actions]: https://github.com/zalxon/components/actions/workflows/main.yml
[mit license]: https://badgen.net/badge/license/MIT/blue
[npm version]: https://badgen.net/npm/v/@zalxon/charts
...
We're designing `@zalxon/charts` with a few goals in mind:
...
This creates the following chart, shown with the `light` and `dark` themes of [`@zalxon/theme`](https://github.com/zalxon/theme).
